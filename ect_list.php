<?php if(isset($_GET['msg']) && esc_sql($_GET['msg'])==1):?>
	<div class="updated below-h2" id="message"><p>Shortcode added successfully</p></div>
<?php elseif(isset($_GET['msg']) && esc_sql($_GET['msg'])==2):?>
...
{
	global $wpdb;
	$wpdb->query("delete from ".$wpdb->prefix."options where option_id='".esc_sql($_GET['id'])."'");
